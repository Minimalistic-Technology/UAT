...
import { uploadQuotationItemImageMiddleware } from '../middleware/upload.middleware';
...
// @access  Private/Admin
router.post('/', auth as any, checkPermission(['product_manager']), uploadQuotationItemImageMiddleware, createQuotationItem);

// @route   PUT api/quotation-items/:id
// @desc    Update a quotation item
// @access  Private/Admin
router.put('/:id', auth as any, checkPermission(['product_manager']), uploadQuotationItemImageMiddleware, updateQuotationItem);
