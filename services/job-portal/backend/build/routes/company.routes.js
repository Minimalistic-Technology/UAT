...
import { createCompany, getCompanies, getCompany, getMyCompany, updateCompany, deleteCompany, uploadCompanyLogo, } from '../controllers/company.controller.js';
...
validate(createCompanySchema), createCompany);
