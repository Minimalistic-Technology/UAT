                ...
                try {
                    ...
                    if (res.data?.success) {
                        ...
                        if (dbUser.phone) {
                            ...
                            const matched = possibleCodes.filter((c: string) => dbUser.phone.startsWith(c)).sort((a: string, b: string) => b.length - a.length)[0];
                            if (matched) {
    ...
    const handleSave = async (updatedData: any) => {
        try {
            ...
            await apiClient.put("/users/profile", {
                ...
                phone: updatedData.phone ? `${updatedData.countryCode}${updatedData.phone}` : "",
                location: {
