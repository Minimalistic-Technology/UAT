  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        data-size={size}
        className={cn(
          "group/alert-dialog-content data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-4 rounded-[24px] border border-slate-100 bg-white p-6 text-slate-800 shadow-[0_20px_60px_rgba(0,0,0,0.12)] duration-100 outline-none data-[size=default]:max-w-md data-[size=sm]:max-w-sm dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200 dark:shadow-none",
          className,
        )}
        {...props}
      />
