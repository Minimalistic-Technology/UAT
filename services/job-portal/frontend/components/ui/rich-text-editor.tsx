...
const MenuBar = ({ editor }: { editor: Editor | null }) => {
  ...
  return (
    <div className="border-border border-b bg-slate-50/50 p-1 dark:bg-slate-900/50">
      <ToggleGroup type="multiple" className="justify-start gap-1">
        ...
        <div className="flex items-center px-1">
          ...
          >
            <SelectTrigger className="border-border h-8 w-[70px] px-2 text-xs shadow-none">
              <SelectValue placeholder="Size" />
            </SelectTrigger>
            <SelectContent className="min-w-[70px]">
              <SelectItem value="12px" className="text-xs">
                12
              </SelectItem>
              <SelectItem value="14px" className="text-xs">
                14
              </SelectItem>
              <SelectItem value="16px" className="text-xs">
                16
              </SelectItem>
              <SelectItem value="18px" className="text-xs">
                18
              </SelectItem>
              <SelectItem value="20px" className="text-xs">
                20
              </SelectItem>
              <SelectItem value="24px" className="text-xs">
                24
              </SelectItem>
              <SelectItem value="30px" className="text-xs">
                30
              </SelectItem>
              <SelectItem value="36px" className="text-xs">
                36
              </SelectItem>
            </SelectContent>
          </Select>
...
export function RichTextEditor({
  ...
  if (!mounted) {
    return (
      <div
        className={cn(
          "border-input overflow-hidden rounded-xl border",
          className,
        )}
      >
        <div className="border-border h-[43px] border-b bg-slate-50/50 dark:bg-slate-900/50" />
        <div className="min-h-[150px] animate-pulse bg-slate-50/20 p-4 dark:bg-slate-800/20" />
      </div>
    );
  }
  ...
  return (
    <div
      className={cn(
        "border-input bg-background overflow-hidden rounded-xl border focus-within:ring-1 focus-within:ring-blue-500",
        className,
      )}
    >
