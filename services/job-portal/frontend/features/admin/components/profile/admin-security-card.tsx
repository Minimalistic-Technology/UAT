  ...
  return (
    <Card className="rounded-[20px] border-0 bg-white shadow-[0_2px_10px_rgba(0,0,0,0.05)] shadow-sm dark:bg-slate-900">
      ...
      <CardContent className="px-8 pb-8">
        <div className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-slate-100 bg-slate-50/80 p-5 sm:flex-row sm:items-center dark:border-slate-800 dark:bg-slate-800/50">
