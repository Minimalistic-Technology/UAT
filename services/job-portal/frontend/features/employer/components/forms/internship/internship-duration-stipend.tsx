...
export function InternshipDurationStipend() {
    const { register, control, watch, formState: { errors } } = useFormContext<CreateInternshipFormData>();
            ...
            <div className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="grid gap-2">
                        ...
                        {errors.duration?.unit && <p className="text-destructive text-xs">{errors.duration.unit.message}</p>}
                    </div>
                    ...
                    {watch("stipend.type") !== "unpaid" && (
                        <>
                            <div className="grid gap-2">
                                ...
                                />
                                {errors.stipend?.amount && <p className="text-destructive text-xs">{errors.stipend.amount.message}</p>}
                            </div>
