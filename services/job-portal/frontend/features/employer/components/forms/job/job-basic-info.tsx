...
import { Job_Type, Work_Mode, Company_Type, Experience_Level, ROLE_CATEGORIES, INDUSTRIES } from "@/features/employer/validations/base-listing.schema";
        ...
        <section className="space-y-6 border-b pb-10 border-border/70">
            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="grid gap-2">
                        <Label>Job Type <Asterisk className="text-destructive inline size-3" /></Label>
                        <Controller
                            name="employmentType"
                            control={control}
                            render={({ field }) => (
                        ...
                        />
                        {errors.employmentType && <p className="text-destructive text-xs">{errors.employmentType.message}</p>}
                    </div>

                    <div className="grid gap-2">
                        <Label>Work Mode <Asterisk className="text-destructive inline size-3" /></Label>
                        <Controller
                            name="workMode"
                            control={control}
                            render={({ field }) => (
                    ...
                    <div className="grid gap-2">
                        <Label>Company Type <Asterisk className="text-destructive inline size-3" /></Label>
                        <Controller
                            name="companyType"
                            control={control}
                            render={({ field }) => (
                    ...
                    <div className="grid gap-2">
                        <Label>Experience Level <Asterisk className="text-destructive inline size-3" /></Label>
                        <Controller
                        ...
                        />
                        {errors.experienceLevel && <p className="text-destructive text-xs">{errors.experienceLevel.message}</p>}
                    </div>
                </div>

                <div className="grid gap-6 md:grid-cols-2">
                    <div className="grid gap-2">
                        <Label className="flex items-center gap-1">Years of Experience <Asterisk className="text-destructive size-3" /></Label>
                        <Input min={0} type="number" {...register("experienceInYears")} placeholder="e.g. 3" />
                        {errors.experienceInYears && <p className="text-destructive text-xs">{errors.experienceInYears.message}</p>}
                    </div>

                    <div className="grid gap-2">
                        <Label className="flex items-center gap-1">Role Category <Asterisk className="text-destructive size-3" /></Label>
                        <Controller
                            name="roleCategory"
                            control={control}
                            render={({ field }) => (
                    ...
                    <div className="grid gap-2">
                        <Label className="flex items-center gap-1">Industry <Asterisk className="text-destructive size-3" /></Label>
                        <Controller
                            name="industry"
                            control={control}
                            render={({ field }) => (
