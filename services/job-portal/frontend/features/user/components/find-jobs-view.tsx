                ...
                <main className="space-y-6 lg:col-span-3">
                    <div className="flex flex-col gap-3 sm:flex-row">
                        <div className="relative flex-1 group">
                            <Search className="text-muted-foreground absolute top-3.5 left-4 h-5 w-5 transition-colors group-focus-within:text-primary" />
                            <Input
                                ref={searchInputRef}
                                placeholder="Search job title, skills, or company..."
                                className="h-12 pl-12 pr-12 rounded-xl border-secondary/20 shadow-sm bg-white dark:bg-slate-900 focus-visible:ring-primary/20 text-base"
                        ...
                        <div className="relative flex-1 group">
                            <MapPin className="text-muted-foreground absolute top-3.5 left-4 h-5 w-5 transition-colors group-focus-within:text-primary" />
                            <Input
                                placeholder="City, state, or 'Remote'"
                                className="h-12 pl-12 rounded-xl border-secondary/20 shadow-sm bg-white dark:bg-slate-900 focus-visible:ring-primary/20 text-base"
                            ...
                            <Sheet>
                                <SheetTrigger asChild>
                                    <Button
                                        variant="outline"
                                        size="lg"
                                        className="flex-1 gap-2 sm:flex-none lg:hidden h-12 rounded-xl font-semibold border-secondary/20 shadow-sm"
                                    >
