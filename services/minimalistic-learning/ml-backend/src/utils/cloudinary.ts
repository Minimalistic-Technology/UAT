...
export const uploadToCloudinary = async (
  ...
  return new Promise((resolve, reject) => {
    // Only apply strict cropping to cover images. For general media (videos, inline images), use original aspect ratio.
    const transformations = isCoverImage 
      ? [
    ...
    const uploadStream = cloudinary.uploader.upload_stream(
      {
        folder,
        resource_type: 'auto', // Support video, raw, image automatically
