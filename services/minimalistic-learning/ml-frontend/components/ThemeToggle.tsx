...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <div 
        className={`absolute w-[26px] h-[26px] rounded-full bg-white dark:bg-gray-950 shadow-[0_2px_10px_rgba(0,0,0,0.15)] dark:shadow-[0_2px_10px_rgba(0,0,0,0.5)] transform transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] flex items-center justify-center ${
