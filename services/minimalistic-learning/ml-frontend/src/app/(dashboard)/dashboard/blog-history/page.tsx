...
const BlogHistoryPage = () => {
 ...
 <Link href="/dashboard" className="w-10 h-10 rounded-xl bg-theme-element-sec flex items-center justify-center text-foreground/50 hover:text-foreground hover:bg-theme-element transition-all border border-theme-accent/10">
 <ArrowLeft size={20} />
 </Link>
 <div>
 ...
 className="inline-flex items-center justify-center w-9 h-9 bg-theme-element border border-theme-accent/20 rounded-xl text-foreground/50 hover:text-red-500 hover:border-red-500/30 hover:bg-red-500/5 transition-all shadow-sm disabled:opacity-50"
 >
