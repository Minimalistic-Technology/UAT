...
export const DatabaseStudio = () => {
 ...
 disabled={loading}
 className="bg-theme-action hover:bg-theme-action/90 text-white text-xs font-black uppercase tracking-wider px-5 py-2 rounded-xl transition-all disabled:opacity-50 flex items-center gap-2 shadow-md "
 >
 {loading ? (
