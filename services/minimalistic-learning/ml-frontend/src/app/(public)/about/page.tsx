...
export default function AboutPage() {
 ...
 <Link href="/blog" className="w-full sm:w-auto px-8 py-3.5 bg-foreground text-background rounded-xl font-black text-sm hover:shadow-lg transition-all flex items-center justify-center gap-2 group">
 Explore Content
 ...
 <p className="text-4xl lg:text-5xl font-black text-foreground tracking-tighter mb-2 group- transition-transform duration-300">
 ...
 <Link href="/register" className="inline-flex items-center justify-center gap-3 px-10 py-4 bg-theme-action text-white rounded-xl font-black text-sm lg:text-base hover:opacity-90 transition-all shadow-xl shadow-theme-action/20">
