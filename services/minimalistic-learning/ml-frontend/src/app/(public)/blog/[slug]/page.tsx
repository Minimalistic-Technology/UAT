...
import ClientBlogFetcher from "@/features/blog/components/ClientBlogFetcher";
...
const BlogDetailPage = async ({ params }: Props) => {
  ...
  // Returning the client fetcher directly instead of Server Component data fetching
  return <ClientBlogFetcher slug={slug} />;
