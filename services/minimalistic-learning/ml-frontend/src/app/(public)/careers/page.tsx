...
export default function CareersPage() {
 ...
 <div className="w-12 h-12 rounded-xl bg-theme-element-sec border border-theme-accent/20 flex items-center justify-center text-foreground/60 shadow-inner group-hover:text-purple-500 group- transition-all">
 <job.icon size={20} />
 </div>
 <div>
