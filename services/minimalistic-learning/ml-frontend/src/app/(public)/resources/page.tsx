...
const ResourcesHub = () => {
 ...
 <div
 key={index}
 className="group bg-white rounded-[2rem] p-10 border border-gray-100 hover:border-blue-200 transition-all shadow-[0_8px_40px_rgba(0,0,0,0.02)] hover:shadow-[0_20px_50px_rgba(24,119,242,0.1)] "
 >
 <div className="w-14 h-14 rounded-2xl bg-blue-50 flex items-center justify-center text-[#1877F2] mb-8 group- transition-transform">
 ...
 <Link
 href="/"
 className="inline-flex items-center gap-3 px-8 py-3.5 bg-[#1877F2] text-white rounded-full font-bold transition-all shadow-xl shadow-blue-500/20"
 >
 Explore Blogs
