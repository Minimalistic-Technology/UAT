...
export default function ServicesPage() {
 return (
 <div className="w-full px-4 sm:px-6 lg:px-8 py-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
 {/* Header Area */}
 <div className="text-center max-w-3xl mx-auto mb-20 lg:mb-12">
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 md:mb-12">
 {/* Main Feature / Span 2 */}
 ...
 <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-cyan-500 text-white flex items-center justify-center mb-8 shadow-lg shadow-emerald-500/20 group- transition-transform duration-500">
 <Code2 size={32} />
 </div>
 ...
 <Link href="#" className="relative z-10 inline-flex items-center justify-center bg-background text-foreground font-black px-8 py-4 rounded-xl transition-transform shadow-2xl">
 Get in Touch
 </Link>
 </div>
 </div>
