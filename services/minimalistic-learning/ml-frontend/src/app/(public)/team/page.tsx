...
export default function TeamPage() {
 ...
 <div className="w-24 h-24 rounded-full bg-theme-element-sec border-4 border-background shadow-xl flex items-center justify-center text-2xl font-black text-emerald-500 mb-6 group- transition-transform duration-300 overflow-hidden relative">
 {t.image ? (
