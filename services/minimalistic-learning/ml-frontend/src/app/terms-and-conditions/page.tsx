...
const TermsAndConditionsPage = () => {
  return (
    <div className="bg-background text-foreground min-h-screen px-6 py-12 sm:px-12 lg:px-24">
      <div className="animate-in fade-in slide-in-from-bottom-4 mx-auto max-w-4xl space-y-8 duration-700">
        <Link
          href="/"
          className="text-theme-action mb-4 inline-flex items-center gap-2 font-bold hover:underline"
        >
          <ArrowLeft size={16} /> Back to Home
        </Link>

        <div className="border-theme-accent/10 space-y-4 border-b pb-8">
        ...
        <div className="prose prose-lg dark:prose-invert prose-headings:font-black prose-p:text-foreground/80 max-w-none">
          ...
          <h3 className="text-foreground mt-8 mb-2 font-black">
