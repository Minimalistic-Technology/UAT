...
export const Footer = () => {
 ...
 <div className="w-10 h-10 rounded-xl overflow-hidden shadow-sm border border-theme-accent/20 flex items-center justify-center bg-white group- transition-transform">
 ...
 <Link href="#" className="hover:text-theme-action transition-all"><FacebookIcon size={18} /></Link>
 <Link href="#" className="hover:text-theme-action transition-all"><TwitterIcon size={18} /></Link>
 <Link href="#" className="hover:text-theme-action transition-all"><LinkedinIcon size={18} /></Link>
 </div>
 </div>
