...
export const Hero = ({ previewData }: { previewData?: any }) => {
 ...
 <GetStartedBtn />
 <Link href="/resources"
 className="group flex items-center gap-3 px-8 py-3.5 bg-theme-element-sec text-foreground border border-theme-accent/20 rounded-xl font-black text-sm hover:shadow-lg transition-all shadow-sm">
 ...
 <section className="relative w-full px-4 sm:px-6 lg:px-8 py-8 bg-theme-element-sec border-t border-theme-accent/10 transition-colors duration-500 overflow-hidden">
 ...
 <div className="w-16 h-16 rounded-[1.5rem] bg-theme-action/10 border border-theme-action/20 flex items-center justify-center text-theme-action shadow-inner group- group-hover:rotate-6 transition-all duration-500 shrink-0">
 <Shield size={28} />
 </div>
 ...
 <div>
 <div className="flex items-start justify-between mb-8 relative z-10">
 <div className="w-16 h-16 rounded-[1.5rem] bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-500 shadow-inner group- group-hover:-rotate-6 transition-all duration-500 shrink-0">
 <Zap size={28} />
 </div>
 <div className="text-right">
 ...
 <div>
 <div className="flex items-start justify-between mb-8 relative z-10">
 <div className="w-16 h-16 rounded-[1.5rem] bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 shadow-inner group- group- transition-transform duration-500 shrink-0">
 <Users size={28} />
 </div>
 <div className="text-right">
 ...
 <Link href="/register"
 className="relative z-10 group/btn flex items-center justify-center gap-3 px-10 py-5 bg-theme-action text-white rounded-2xl font-black text-sm lg:text-base hover:opacity-90 transition-all shadow-xl shadow-theme-action/20 shrink-0 w-full md:w-auto">
 Join the Platform
