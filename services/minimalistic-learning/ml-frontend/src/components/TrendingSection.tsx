...
export default function TrendingSection({ trendingBadge, trendingTitle }: TrendingSectionProps = {}) {
 ...
 if (loading) return (
 <section className="w-full px-[5%] py-12 bg-background">
 ...
 return (
 <section className="w-full px-4 sm:px-6 lg:px-8 py-12 bg-background border-t border-theme-accent/10 relative">
 ...
 <Link href="/blog" className="group flex items-center gap-3 px-8 py-3.5 bg-foreground text-background rounded-full text-sm font-bold shadow-md shadow-foreground/10 transition-all shrink-0">
 See All Articles
