...
const LoginForm = () => {
  ...
  return (
    <Card className="animate-in fade-in zoom-in mx-auto w-full duration-300">
      <div className="mb-8 flex flex-col items-center">
        <h2 className="mb-2 text-[28px] font-bold tracking-tight text-gray-900 dark:text-white">
          Welcome Back
        </h2>
      ...
      <div className="animate-in mt-8 text-center duration-200">
