...
export const BlogDetail: React.FC<BlogDetailProps> = ({ blog, latestBlogs = [] }) => {
 ...
 className={hasLiked ? "text-red-500 scale-110" : "text-foreground/50 group-hover:text-red-500 group- transition-transform"}
 />
 ...
 className="flex items-center gap-2.5 group transition-all"
 >
 <MessageCircle size={22} className="text-foreground/50 group-hover:text-theme-action group- transition-transform" />
 ...
 className="px-8 py-3 bg-foreground text-background rounded-xl text-sm font-black transition-all shadow-md disabled:opacity-50 "
 >
 ...
 <button
 onClick={handleLike}
 className={`w-full mt-8 py-4 rounded-xl font-black text-sm transition-all focus:outline-none flex justify-center shadow-md ${hasLiked
