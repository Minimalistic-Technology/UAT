...
export const BlogList: React.FC<BlogListProps> = ({ limit, hideControls }) => {
    ...
    if (error) {
        return <ErrorRetryBlock error={{ message: error }} message="Went something wrong" onRetry={() => window.location.reload()} />;
    }
            ...
            {loading ? (
                ...
                <div className="text-center py-32 px-6 bg-gray-50/50 dark:bg-gray-900/20 rounded-[3rem] border border-dashed border-gray-200 dark:border-gray-800">
                    ...
                    <button
                        ...
                        className="px-8 py-3.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-full font-bold text-sm transition-transform shadow-md"
                    >
                        View All Stories
                    </button>
                </div>
