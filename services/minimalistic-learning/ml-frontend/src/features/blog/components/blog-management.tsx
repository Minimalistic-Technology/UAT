...
export const BlogManagement = () => {
    ...
    if (error) {
        return <ErrorRetryBlock error={error} message="Went something wrong" onRetry={refetch} />;
    }
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <Link
                    href="/blog/create"
                    className="flex items-center justify-center gap-2 px-6 py-3.5 bg-theme-action text-white rounded-2xl font-bold text-sm transition-all shadow-md"
                >
                    <Plus size={18} />
                    Create New Post
                </Link>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-1 bg-theme-element-sec border border-theme-accent/10 rounded-2xl md:ml-auto">
                                    ...
                                    <Link
                                        ...
                                        className="p-3 text-foreground/70 hover:text-theme-action hover:bg-theme-element rounded-xl transition-all shadow-sm group-hover:shadow cursor-pointer"
                                        title="Edit post"
                                    >
                                        <Edit2 size={18} />
                                    </Link>
