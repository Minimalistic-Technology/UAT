...
export const BlogPreview: React.FC<BlogPreviewProps> = ({
 ...
 {tags.map((tag, idx) => (
 <span key={idx} className="px-3 py-1 bg-emerald-100/50 text-emerald-700 text-xs font-semibold rounded-full border border-emerald-200/50 backdrop-blur-sm shadow-sm transition-all ">
 #{tag}
 </span>
 ))}
 </div>
